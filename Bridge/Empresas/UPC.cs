...
namespace Bridge.Empresas
{
    public class UPC : lEmpresas
    {
        ...
        public UPC(List<lEnvios> _lstEnvio, Decimal _dMargenUtilidad, string _cNombre)
        {
        ...
        public decimal TiempoTraslado(State.State _entPedido)
        {
            ...
            else
            {
                ...
                Console.WriteLine($"UPC no ofrece el servicio de transporte {_entPedido.cMedioTransporte.cNombre}, te recomendamos cotizaren otra empresa.");
            }
